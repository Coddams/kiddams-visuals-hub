      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-left">
            ...
            <Button className="bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-8 py-3 rounded-none font-medium tracking-wider transition-all duration-300 hover:scale-105 animate-fade-in hover:shadow-lg hover:shadow-purple-500/50">
              LET'S TALK
            </Button>
          </div>
          ...
          <div className="relative">
            ...
            {/* Floating icons */}
            <div className="absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-r from-purple-600 to-purple-700 rounded-lg flex items-center justify-center animate-bounce hover:shadow-lg hover:shadow-purple-500/50 cursor-pointer">
              <span className="text-white font-bold text-xl">Pr</span>
            </div>
            <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg flex items-center justify-center animate-bounce delay-1000 hover:shadow-lg hover:shadow-purple-500/50 cursor-pointer">
